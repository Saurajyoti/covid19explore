...
```{r by country, fig.height=20, fig.width=20, echo=F,  warning=F, error=F, message=F}
d2_glo <- d1_glo %>%
...
```{r date vs cases by US province, fig.height=16, fig.width=20, echo=F,  warning=F, error=F, message=F, fig.keep='all'}
d3_usa <- d1_usa %>% 
...
```{r understanding the increase over day, fig.height=20, fig.width=20, echo=FALSE, message=FALSE, results='hide',fig.keep='all'}
d4_glo <- d3_glo
